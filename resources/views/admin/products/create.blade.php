                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="number" name="regular_price" class="form-control" value="{{ old('regular_price') }}" min="0" step="0.01" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Sale Price (৳)</label>
                            <input type="number" name="sale_price" class="form-control" value="{{ old('sale_price') }}" min="0" step="0.01">
                        </div>
                        <div class="col-md-4">
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-check mb-2">
                        <input type="checkbox" class="form-check-input" name="is_new_arrival" value="1" {{ old('is_new_arrival', true) ? 'checked' : '' }}>
